...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const eateriesGrid = document.getElementById("eateriesGrid");
    const eaterySearch = document.getElementById("eaterySearch");
    ...
    if (eaterySearch) {
        eaterySearch.addEventListener("input", filterEateries);
    }

    if (categoryFilter) {
        categoryFilter.addEventListener("change", filterEateries);
    }

    if (locationFilter) {
        locationFilter.addEventListener("change", filterEateries);
    }
    ...
    const menuItems = [

        {
            ...
            category: "Breakfast",
            description: "A delicious Kenyan-style breakfast to start your day.",
            price: 350,
...

        {
            ...
            category: "Breakfast",
            description: "Soft pancakes served with freshly prepared coffee.",
            price: 450,
...

        {
            ...
            category: "Lunch",
            description: "Tender beef stew served with traditional Kenyan ugali.",
            price: 550,
            restaurant: "Thika Food House",
            image: "Images/restaurant-1.jpg"
        },
...

        {
            ...
            category: "Dinner",
            description: "Juicy grilled chicken prepared with delicious spices.",
            price: 750,
...

        {
            name: "Beef Burger",
            category: "Fast Food",
            description: "A juicy beef burger served with crispy fries.",
            price: 600,
...

        {
            ...
            category: "Fast Food",
            description: "Classic pizza topped with cheese and fresh tomato.",
            price: 900,
...

        {
            name: "Fresh Juice",
            category: "Drinks",
            description: "Refreshing fruit juice prepared from fresh fruits.",
            price: 250,
            restaurant: "Thika Coffee Spot",
            image: "Images/gallery-3.jpg"
        },

        {
            name: "African Tea",
            category: "Drinks",
            description: "Traditional Kenyan tea served hot and fresh.",
            price: 180,
            restaurant: "Thika Coffee Spot",
            image: "Images/restaurant-2.jpg"
        },
...

        {
            name: "Fruit Cake",
            category: "Desserts",
            description: "Freshly baked cake with delicious fruit toppings.",
            price: 400,
            restaurant: "Sweet Treats Café",
    ...
    console.log("Thika Eateries JavaScript loaded successfully.");
